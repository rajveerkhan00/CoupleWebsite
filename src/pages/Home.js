      ...
      <nav className="main-navigation">
        <div className="navigation-container flex flex-wrap items-center justify-between py-5 px-4 md:px-8 bg-white/90 backdrop-blur-sm shadow-md">
          ...
          <div className="navigation-links flex flex-wrap justify-center space-x-4 md:space-x-8 mt-4 md:mt-0">
            <a href="#home" className="gjs-t-link home-link hover:text-rose-600 transition-all duration-300 font-medium floating-nav-item text-sm md:text-base">Home</a>
            <a href="#about" className="gjs-t-link about-link hover:text-rose-600 transition-all duration-300 font-medium floating-nav-item text-sm md:text-base">About Us</a>
            <a href="#timeline" className="gjs-t-link timeline-link hover:text-rose-600 transition-all duration-300 font-medium floating-nav-item text-sm md:text-base">Our Journey</a>
            <a href="#gallery" className="gjs-t-link gallery-link hover:text-rose-600 transition-all duration-300 font-medium floating-nav-item text-sm md:text-base">Gallery</a>
            <a href="#memories" className="gjs-t-link memories-link hover:text-rose-600 transition-all duration-300 font-medium floating-nav-item text-sm md:text-base">Memories</a>
            <a href="#messages" className="gjs-t-link messages-link hover:text-rose-600 transition-all duration-300 font-medium floating-nav-item text-sm md:text-base">Messages</a>
